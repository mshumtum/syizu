...
function* getAllChatrooms(action) {
  var act = action;
  getToken();
...
export default function* getAllChatroomsSaga() {
  yield takeEvery(GET_ALL_CHAT_ROOM, getAllChatrooms);
}
