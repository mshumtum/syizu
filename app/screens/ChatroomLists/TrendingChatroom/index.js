...
const TrendingChatroom = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    dispatch(getAllTrendingChatroom({callBack}));
    // getToken();
  }, []);
        ...
        <View>
          <View
            ...
            <Text
              ...
              Trending <Text style={{color: appColors.grey}}> Chatrooms</Text>
            </Text>
          </View>
          <FlatList
...
export default TrendingChatroom;
